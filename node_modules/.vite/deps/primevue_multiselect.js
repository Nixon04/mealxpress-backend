...
import {
  ...
  script4 as script6,
  script5 as script7
} from "./chunk-N5VXPM3S.js";
import {
  script as script2
} from "./chunk-QWT5SQVF.js";
import {
  Ripple
} from "./chunk-RAEEOSPD.js";
import {
  ConnectedOverlayScrollHandler,
  UniqueComponentId
} from "./chunk-OERKKFRX.js";
import "./chunk-RKZRD65P.js";
import {
  ZIndex
} from "./chunk-X2TUEFZ3.js";
import {
  script
} from "./chunk-OI5KTYML.js";
import {
  BaseStyle,
  absolutePosition,
  addStyle,
...
var script18 = {
  ...
  methods: {
    ...
    onOptionSelect: function onOptionSelect(event, option2) {
      ...
      else value = [].concat(_toConsumableArray2(this.d_value || []), [this.getOptionValue(option2)]);
      this.updateModel(event, value);
      ...
      if (this.filterValue) {
        ...
        if (this.optionGroupLabel) {
          ...
          optionGroups.forEach(function(group) {
            ...
            if (filteredItems.length > 0) filtered.push(_objectSpread2(_objectSpread2({}, group), {}, _defineProperty$1({}, typeof _this25.optionGroupChildren === "string" ? _this25.optionGroupChildren : "items", _toConsumableArray2(filteredItems))));
          });
...
function render11(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
  ...
  }, _ctx.ptm("hiddenInput")), null, 16, _hoisted_14)], 16), createBaseVNode("div", mergeProps({
    ...
    return [_ctx.display === "comma" ? (openBlock(), createElementBlock(Fragment, {
      ...
      key: 1
    }, [$options.chipSelectedItems ? (openBlock(), createElementBlock("span", _hoisted_23, toDisplayString($options.label), 1)) : (openBlock(true), createElementBlock(Fragment, {
      key: 1
