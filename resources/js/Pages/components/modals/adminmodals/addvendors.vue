<template>
    <div class="bg-drawer-center" v-if="addVisible">
      <div class="bg-drawer-center-container">
        <div class="d-flex justify-content-between px-5 py-5">
          <h1 class="fs-5 fw-bold">Register Vendors</h1>
        ...
        <div class="container-scrollable px-5">
          ...
          <div class="form-input mb-3">
            ...
            <div class="form-inputs mb-3 position-relative">
              <input :type="passwordfield" id="password" v-model="vendorsPassword" class="py-3 form-control" placeholder="Enter Password" autofocus>
    ...
    <div class="form-input mb-3">
      ...
      <div class="form-input mb-3">
        <label for="vendorbio">MarketBio(Description of your Business)</label>
         <textarea v-model="vendorbio" rows="3" class="form-control"></textarea>
      </div>
       
        <div class="form-input mb-3">
            <label for="storecollection">Choose Market</label>
            <select v-model="vendorcollection" id="storecollection" class="form-select py-3">
  ...
  export default {
    ...
    this.showPassword =! this.showPassword;
      ...
      submitProduct() {
        // if (!this.Contact || !this.vendorEmail || !this.vendorSenderMail
        ...
        formData.append('vendorcollection', this.vendorcollection);
        formData.append('productImage', this.file); // Send the image data
        console.log('Parameters', ...formData);
