        ...
        <div class="container-scrollable px-5">
          ...
          <div class="form-input mb-3">
            ...
            <input
              ...
              placeholder="Enter unique ID e.g ML@32932"
            />
          </div>
  ...
  export default {
    ...
    methods: {
      ...
      submitProduct() {
        ...
        if (!this.inputname || !this.inputprice || !this.inputid || !this.inputweight || !this.image || !this.kgcall) {
        ...
        formData.append('productID',this.inputid);
