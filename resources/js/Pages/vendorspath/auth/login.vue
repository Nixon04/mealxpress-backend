...
<template>
  <div>
    <!-- header -->
    <Head>
      <title>Mealxpress | Login Page</title>
    </Head>
    <div class="mealxpress-background-set">
        ...
        <div class="login-container-set">
         <div class="login-spacing mb-5">
            <h1 class="bg-center-text fs-3 fw-bold bg-color-primary mb-2">Login to your accounts</h1>
            <h6 class="bg-center-text bg-color-primary">Securely login to your Mealxpress vendors app</h6>
         </div>     
  ...
  async LoginSubmit(){
    ...
    try{
      ...
      if(response.status == "419"){
        console.log('Error evaluating process');
        return;
      }
