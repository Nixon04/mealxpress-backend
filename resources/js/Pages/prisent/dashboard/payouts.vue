<template>
  <Head>
    <title>Mealxpress | Payouts Information and Registration</title>
  </Head>
                  ...
                  <div class="d-flex justify-content-between px-6">
                      ...
                      <div class="d-flex gap-4">
                          ...
                          <div class="meal-form-button">
                              <button @click="ShowCenterModel(item)" class="togglebutton btn bg-button-submit py-3 text-sm">Add Payouts</button>
                          </div>
                      </div>
                  </div>
                  <div class="card-body">
