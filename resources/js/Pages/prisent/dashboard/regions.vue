<template>
                      ...
                      <div class="d-flex justify-content-between px-6">
                          ...
                          <div class="d-flex gap-4">
                              ...
                              <div class="meal-form-button">
                                  <button @click="ShowCenterModel(item)" class="togglebutton btn bg-button-submit py-3 text-sm">Add Regions</button>
                              </div>
                          </div>
                      </div>
                      <div class="card-bod">
    ...
    import AddCategory from './../../components/modals/adminmodals/regioncategory.vue';
    import DeleteModel from './../../components/modals/adminmodals/deletelocation.vue';
    ...
    await delay(1000);
    try {
      const response = await axios.post('/prisent/dashboard/deletelocation', payload, {
        headers: {
